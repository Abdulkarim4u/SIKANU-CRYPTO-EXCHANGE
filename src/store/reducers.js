import { combineReducers } from 'redux';  //reducers is our redux store for updates.
...
function exchange(state = {}, action) {
  ...
  switch (action.type) {
    ...
    case 'ORDER_CANCELLING':
      return { ...state, orderCancelling: true } // this is to update the ui with spinner
    ...
    case 'ETHER_DEPOSIT_AMOUNT_CHANGED':
      return { ...state, etherDepositAmount: action.amount } //when deposit in the form.
    ...
    case 'BUY_ORDER_AMOUNT_CHANGED':
      return { ...state, buyOrder: { ...state.buyOrder, amount: action.amount } } //buy order
