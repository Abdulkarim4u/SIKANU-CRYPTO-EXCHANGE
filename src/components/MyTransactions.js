...
import { //importing all our selectors.
...
const showMyFilledOrders = (props) => {  //orders that have been filled already
        ...
        return (
          <tr key={order.id}>
            ...
            <td
              ...
              onClick={(e) => {
                cancelOrder(dispatch, exchange, order, account) //we imported cancelorder from interactions.
              }}
            >X</td>
          </tr>
        )
